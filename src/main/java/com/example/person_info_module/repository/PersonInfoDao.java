...
public interface PersonInfoDao extends JpaRepository<PersonInfo, Integer>{
    ...
    @Query(value = "select * from person_info where name like concat ('%', :keyword, '%')", nativeQuery = true)
    public List<PersonInfo> findByNameLike(@Param("keyword")String str);

    @Query(value = "select * from person_info where name_katagana like concat ('%', :keyword, '%')", nativeQuery = true)
    public List<PersonInfo> findByNameKataganaLike(@Param("keyword")String str);

    @Query(value = "select * from person_info where name_roma like concat ('%', :keyword, '%')", nativeQuery = true)
    public List<PersonInfo> findByNameRomaLike(@Param("keyword")String str);
